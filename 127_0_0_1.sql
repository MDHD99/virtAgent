...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 25, 2019 at 06:08 PM
...
-- Database: `fithunter`
--
CREATE DATABASE IF NOT EXISTS `fithunter` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fithunter`;
...
(124, 'mhmd', 'hammoud', 'mhmd@mhmd.com', 'MDHD', 'mypass123');
COMMIT;
